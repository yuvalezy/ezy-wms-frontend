  ...
  return (
    <nav className="bg-white p-4 flex items-center justify-between relative z-20 shadow-md">
      ...
      {!onBack && (
        <>
          <div
            className={`fixed top-0 left-0 h-full bg-white text-gray-800 w-64 transform ${isMenuOpen ? 'translate-x-0' : '-translate-x-full'} transition-transform duration-300 ease-in-out z-30 flex flex-col shadow-lg`}>
